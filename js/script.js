...
function adjustSize() {
    ...
    document.getElementById('container-impressum').style.left = document.defaultView.getComputedStyle(document.getElementById('left-hotbar'), "").getPropertyValue("width");
    ...
    document.getElementById('container-contact').style.left = document.defaultView.getComputedStyle(document.getElementById('left-hotbar'), "").getPropertyValue("width");
    ...
    document.getElementById('container-privacy').style.left = document.defaultView.getComputedStyle(document.getElementById('left-hotbar'), "").getPropertyValue("width");
